...
class CreateTravelerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'items.*.part_number' => ['required', 'integer', 'unique:inspection_traveler_items,part_number'],
    ...
    public function messages(): array
    {
        return [
            ...
            'items.*.part_number.unique' => 'Part number must be unique at position :position.',
            ...
            'operations.*.outside_ops.integer' => 'Outside operations must be a integer at position :position.',

            'operations.*.vendor.required' => 'Vendor is required at position :position.',
            'operations.*.vendor.integer' => 'Vendor must be a integer at position :position.',
